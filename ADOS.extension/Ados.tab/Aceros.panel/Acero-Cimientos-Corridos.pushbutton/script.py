...
# 1. Recubrimiento + Modo de armado fusionados en UN solo Border (menos altura).
# 2. Modo de armado: Grid de dos columnas proporcionales (ya no BorderBrush interior)
#    para que los dos radio-buttons sean visibles completos.
XAML_VENTANA = u"""
<Window
  ...
  <StackPanel Margin="14">
    ...
    <Border Background="White" CornerRadius="6" Padding="12" Margin="0,0,0,8"
      ...
      <StackPanel>
        ...
        <!-- Fila: título Recubrimiento a la izquierda -->
        <TextBlock Text="Recubrimiento" FontSize="10" FontWeight="Bold"
                   Foreground="#2E7D32" Margin="0,0,0,6"/>

        <!-- Recubrimiento + Desfase inferior -->
        <Grid Margin="0,0,0,12">
          ...
          <StackPanel Grid.Column="0">
            ...
            <TextBox x:Name="txtRecub" Text="25" Height="28" Padding="6,4"
                     BorderBrush="#BDBDBD" BorderThickness="1"/>
          </StackPanel>
          <StackPanel Grid.Column="2">
            <TextBlock Text="Desfase inferior (cm)" Foreground="#555" Margin="0,0,0,3"/>
            <TextBox x:Name="txtDesfaseInf" Text="0" Height="28" Padding="6,4"
                     BorderBrush="#BDBDBD" BorderThickness="1"/>
          </StackPanel>
        </Grid>
        ...
        <Grid>
          ...
          <Border Grid.Column="0" CornerRadius="4" BorderBrush="#2E7D32" BorderThickness="1"
                  Padding="4,2">
            <RadioButton x:Name="rbUnaCara" Content="Una Cara / Eje" GroupName="modo"
                         IsChecked="False" Padding="4,4" FontWeight="SemiBold"
                         HorizontalAlignment="Center"/>
          </Border>
          <Border Grid.Column="2" CornerRadius="4" BorderBrush="#2E7D32" BorderThickness="1"
                  Padding="4,2">
    ...
    <Border Background="White" CornerRadius="6" Padding="12" Margin="0,0,0,8"
      ...
      <StackPanel>
        <TextBlock x:Name="lblCara1" Text="CARA 1  —  Cara exterior (normal -)"
                   FontSize="10" FontWeight="Bold" Foreground="#2E7D32" Margin="0,0,0,8"/>

        <!-- Horizontal Cara 1 -->
        <Border Background="#F1F8E9" CornerRadius="4" Padding="10,8" Margin="0,0,0,8"
                BorderBrush="#C5E1A5" BorderThickness="1">
          <StackPanel>
            <TextBlock Text="HORIZONTAL  —  a lo largo del muro" FontWeight="SemiBold"
                       Foreground="#33691E" Margin="0,0,0,8"/>
            <Grid>
              <Grid.ColumnDefinitions>
                <ColumnDefinition Width="*"/>
                <ColumnDefinition Width="8"/>
        ...
        <!-- Vertical Cara 1 -->
        <Border Background="#F9FBE7" CornerRadius="4" Padding="10,8"
                BorderBrush="#DCE775" BorderThickness="1">
          <StackPanel>
            <TextBlock Text="VERTICAL  —  a lo alto del muro" FontWeight="SemiBold"
                       Foreground="#827717" Margin="0,0,0,8"/>
            <Grid>
              <Grid.ColumnDefinitions>
                <ColumnDefinition Width="*"/>
                <ColumnDefinition Width="8"/>
    ...
    <Border x:Name="panelCara2" Background="White" CornerRadius="6" Padding="12" Margin="0,0,0,8"
            BorderBrush="#80DEEA" BorderThickness="1">
      <StackPanel>
        <TextBlock Text="CARA 2  —  Cara interior (normal +)" FontSize="10"
                   FontWeight="Bold" Foreground="#00695C" Margin="0,0,0,8"/>

        <!-- Horizontal Cara 2 -->
        <Border Background="#E0F7FA" CornerRadius="4" Padding="10,8" Margin="0,0,0,8"
                BorderBrush="#80DEEA" BorderThickness="1">
          <StackPanel>
            <TextBlock Text="HORIZONTAL  —  a lo largo del muro" FontWeight="SemiBold"
                       Foreground="#006064" Margin="0,0,0,8"/>
            <Grid>
              <Grid.ColumnDefinitions>
                <ColumnDefinition Width="*"/>
                <ColumnDefinition Width="8"/>
        ...
        <!-- Vertical Cara 2 -->
        <Border Background="#E8F5E9" CornerRadius="4" Padding="10,8"
                BorderBrush="#A5D6A7" BorderThickness="1">
          <StackPanel>
            <TextBlock Text="VERTICAL  —  a lo alto del muro" FontWeight="SemiBold"
                       Foreground="#1B5E20" Margin="0,0,0,8"/>
            <Grid>
              <Grid.ColumnDefinitions>
                <ColumnDefinition Width="*"/>
                <ColumnDefinition Width="8"/>
    ...
    <Border Background="White" CornerRadius="6" Padding="12" Margin="0,0,0,10"
      ...
      <StackPanel>
        ...
        <Button x:Name="btnSeleccionar"
                Content="Seleccionar muros en Revit"
                Height="32" Cursor="Hand"
                Background="#E8F5E9" Foreground="#2E7D32"
                FontWeight="SemiBold" BorderBrush="#A5D6A7" BorderThickness="1"/>
    ...
    def on_seleccionar(self, sender, e):
        ...
        try:
            refs = uidoc.Selection.PickObjects(
                ...
                'Selecciona los muros y presiona ENTER para confirmar')
            self.muros_ids = [r.ElementId for r in refs]
            n = len(self.muros_ids)
            self.lblContador.Text       = '{} muro{} seleccionado{}'.format(
